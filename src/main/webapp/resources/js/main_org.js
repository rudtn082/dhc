...
//종목명 검색 (서브)
$(document).keyup("#code2", function() {
	if($("#code2").val().length > 1) {
		var searchText = $("#code2").val().toUpperCase();
		var param = {
				'searchText' : searchText
		};
...
//종목명 클릭 (서브)
$(document).on("click", "#codeList2 li", function() {
	if($(this).attr("code2") != "") {
		$("#code2").val($(this).text());
		$("#code").val('');
		$("#codeList2").hide();
